...
export const LOCAL_CONTACTS_FULL_DISK_ACCESS_MESSAGE =
  "Scrollbuddy needs Full Disk Access to read Contacts for iMessage contact matching. In System Settings -> Privacy & Security -> Full Disk Access, add Scrollbuddy for the desktop app or your terminal for npm run dev, then restart Scrollbuddy.";
