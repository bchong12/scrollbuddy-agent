...
export const LOCAL_MESSAGES_FULL_DISK_ACCESS_MESSAGE =
  "Scrollbuddy needs Full Disk Access to read Messages. In System Settings → Privacy & Security → Full Disk Access, add Scrollbuddy for the desktop app or your terminal for npm run dev, then restart Scrollbuddy.";
