...
export const LOCAL_REMINDERS_ACCESS_MESSAGE =
  "Scrollbuddy needs macOS Automation permission to read Apple Reminders. When prompted, allow Scrollbuddy or the terminal app running npm run dev to control Reminders. You can also enable it in System Settings -> Privacy & Security -> Automation. Access is read-only.";
